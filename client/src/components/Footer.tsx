...
export function Footer() {
  return (
    <footer className="bg-background dark:bg-black pt-24 pb-12 border-t border-border dark:border-white/5 relative overflow-hidden">
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[1000px] h-[300px] bg-[hsl(var(--cobalt))]/10 dark:bg-[hsl(var(--cobalt))]/20 blur-[150px] pointer-events-none rounded-t-full" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <h4 className="text-foreground dark:text-white font-semibold mb-6">Navigation</h4>
            <ul className="space-y-4">
              {["Services", "Case Studies", "Company", "Careers"].map(link => (
                <li key={link}>
                  <a href="#" className="text-slate-600 dark:text-slate-400 hover:text-foreground dark:hover:text-white transition-colors magnetic-interactive">{link}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            <h4 className="text-foreground dark:text-white font-semibold mb-6">Socials</h4>
            <ul className="space-y-4">
        ...
        <div className="pt-8 border-t border-border dark:border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
