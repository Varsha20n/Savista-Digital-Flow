    ...
    <section ref={containerRef} className="relative min-h-screen flex items-center pt-24 pb-12 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full relative z-10">
        <div className="max-w-4xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 mb-8 hero-fade-in">
            <span className="w-2 h-2 rounded-full bg-[hsl(var(--cyan))] animate-pulse" />
            <span className="text-xs font-medium tracking-wide uppercase text-slate-600 dark:text-slate-300">Premium Software Development</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 max-w-2xl mb-12 hero-fade-in font-sans font-light leading-relaxed">
          ...
          <div className="hero-fade-in flex flex-wrap gap-6 items-center">
            ...
            <button 
              ...
              className="px-8 py-4 rounded-full font-semibold text-foreground dark:text-white tracking-wide border border-transparent hover:border-black/10 dark:hover:border-white/20 transition-all duration-300 magnetic-interactive group"
            >
